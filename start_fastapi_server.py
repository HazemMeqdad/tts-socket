#!/usr/bin/env python3
"""
Script to start the MeloTTS FastAPI server.
...
from melotts_fastapi import start_server

def main():
    parser = argparse.ArgumentParser(description="Start the MeloTTS FastAPI server")
    parser.add_argument(
